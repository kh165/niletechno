      ...
      <div className="max-w-7xl 2xl:max-w-[1360px] 3xl:max-w-[1580px] 4xl:max-w-[1720px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`max-w-4xl mx-auto rounded-2xl border overflow-hidden shadow-2xl transition-all duration-300 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 min-h-[380px]">
            ...
            <div className="md:col-span-8 lg:col-span-9 p-4 sm:p-6 flex flex-col justify-between">
                    ...
                    <div>
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                        ...
                        <button
                          ...
                          className="min-h-[40px] px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white text-xs font-bold rounded-xl font-cairo cursor-pointer flex items-center justify-center gap-2 shadow-md shadow-emerald-500/10 active:scale-95 transition-all outline-none w-full sm:w-auto shrink-0"
                        >
                          <TrendingUp className="w-4 h-4 shrink-0" />
                          <span className="whitespace-nowrap">{lang === 'ar' ? 'أضف حركة بيع (لايف)' : 'Post Sale Transaction'}</span>
                        </button>
                      </div>
